...
public class Gdelt3WMediaProcessor implements ItemProcessor<Gdelt3W, Gdelt3W> {
    ...
    public Gdelt3W process(Gdelt3W gdelt3W) throws Exception {
        ...
        if(imgFileURL != null){
            ...
            imgFileName = FilePathSpec.GDELT_3W_SIGNATURE + "_" + gdelt3W.getGdelt3w_id()+ "_" + imgFileName;

            System.out.println("imgFileName : " + imgFileName);
            HttpDownloadUtility.UserAgentBasedDownloadFile(gdelt3W.getImgURL(), FilePathSpec.GDELT_IMAGE_PATH, imgFileName);
        ...
        if(articleFileURL != null){
            ...
            articleFileName = FilePathSpec.GDELT_3W_SIGNATURE + "_" + gdelt3W.getGdelt3w_id()+ "_" + articleFileName;

            System.out.println("articleFileURL : " + articleFileURL);
            System.out.println("articleFileName : " + articleFileName);

            HttpDownloadUtility.UserAgentBasedDownloadFile(gdelt3W.getArticleURL() , FilePathSpec.GDELT_ARTICLE_PATH, articleFileName);
