...
Will replace it once pull request is merged in default Connect Controller.
 *
 *
 */
...
public class CustomConnectController extends ConnectController {
	...
	private final static Log logger = LogFactory.getLog(CustomConnectController.class);
...
//			addConnection(connection, connectionFactory, request);
	...
	private void updateConnection(Connection<?> connection, ConnectionFactory<?> connectionFactory, WebRequest request) {
		try {
