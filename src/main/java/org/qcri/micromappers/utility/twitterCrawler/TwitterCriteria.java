...
public class TwitterCriteria {
	...
	public TwitterCriteria includeRetweets() {
		this.includeRetweet = Boolean.TRUE;
		return this;
	}
	...
	/**
	 * @return the includeRetweet
	 */
	public Boolean getIncludeRetweet() {
		return includeRetweet;
	}

	/**
	 * @param includeRetweet the includeRetweet to set
	 */
	...
	public String toString() {
		return "TwitterCriteria [username=" + username + ", since=" + since + ", until=" + until + ", querySearch="
				+ querySearch + "]";
	}
